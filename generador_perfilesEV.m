...
[~, ~, raw] = xlsread('C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Origen-destinoV2\Modelo Carga EV\datosEV.xlsx','Sheet1','A2:E6');
...
csvwrite('C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Origen-destinoV2\Modelo Carga EV\Casos\Perfiles_EV_rapido' + caso + '.csv',matriz_carga_def);
csvwrite('C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Origen-destinoV2\Modelo Carga EV\Casos\Perfiles_EV_domiciliario' + caso + '.csv',matriz_carga_dom_def);
csvwrite('C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Origen-destinoV2\Modelo Carga EV\Casos\matriz_SoC_anual' + caso + '.csv',matriz_SoC_def);
csvwrite('C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Origen-destinoV2\Modelo Carga EV\Casos\matriz_E_dia' + caso + '.csv',matriz_E_hora_def);
csvwrite('C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Origen-destinoV2\Modelo Carga EV\Casos\matriz_km_dia' + caso + '.csv',matriz_km_hora_def);
csvwrite('C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Origen-destinoV2\Modelo Carga EV\Casos\user_EV' + caso + '.csv',user_id);
